...
@section('content')
    ...
    <div class="box">
        <div class="box-header with-border">
            <h2 class="box-title">Chỉnh Sửa Sản Phẩm</h1>
                        ...
                        <div class="nav-tabs-custom">
                            ...
                            <div class="tab-content">
                                ...
                                <div class="active tab-pane" id="activity">
                                    ...
                                    <div class="form-group col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12 @if($errors->first('category_id')) has-error @endif">
                                            <select name="category_id" id="category_id"  class="form-control" style="width: 100%;" tabindex="-1" aria-hidden="true">
                                                ...
                                                <?php cateParent($dataCate, $dataProducts->category_id); ?>
                                    ...
                                    <div class="form-group col-md-12 col-sm-12 col-xs-12">
                                        <div class="col-md-3 col-sm-6 col-xs-12 ">
                                             <label for="exampleInputEmail1">Thuộc nhà sản suất <span class="obligatory">*</span></label>
                                        </div>
                                        <div class="col-md-6 col-sm-6 col-xs-12 @if($errors->first('supplier_id')) has-error @endif">
                                            <select name="supplier_id" id="supplier_id"  class="form-control" style="width: 100%;" tabindex="-1" aria-hidden="true">
                                                <option value="">---- Chọn nhà sản suất ----</option>
                                                 @foreach($suppliers as $val)
                                                     <option @if($dataProducts->supplier_id == $val['id'] ) selected ="selected" @endif value="{{ $val['id']}}">{{ $val['name']}}</option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="form-group col-md-12 col-sm-12 col-xs-12 ">
                                        ...
                                        <div class=" form-group  col-md-6 col-sm-6 col-xs-12 @if($errors->first('price')) has-error @endif">
                                            <input type="number" min="0" name="price" class="form-control" id="exampleInputWallets" placeholder="" maxlength="255" value="{!! old('price',isset($dataProducts)?$dataProducts->price:NULL) !!}">
                                    ...
                                    <div class="form-group col-md-12 col-sm-12 col-xs-12 ">
                                        ...
                                        <div class=" form-group  col-md-6 col-sm-6 col-xs-12 @if($errors->first('sale')) has-error @endif">
                                            <input type="number" min="0"  max="100" name="sale" class="form-control" id="exampleInputWallets" placeholder="" maxlength="255" value="{!! old('sale',isset($dataProducts)?$dataProducts->sale:NULL) !!}">
                                    ...
                                    <div class="form-group col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <select name="unit" id="unit"   class="form-control" style="width: 100%;" tabindex="-1" aria-hidden="true">
                                                <option @if(old('unit', isset($dataProducts)?$dataProducts->unit : NULL) == 'Sản phẩm' ) selected ="selected" @endif value="Sản phẩm" >Sản phẩm</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group col-md-12 col-sm-12 col-xs-12 ">
                                        ...
                                        <div class=" form-group  col-md-6 col-sm-6 col-xs-12 @if($errors->first('total')) has-error @endif">
                                            <input type="number" min="0" name="total" class="form-control" id="exampleInputWallets" placeholder="" maxlength="255" value="{!! old('total',isset($dataProducts)?$dataProducts->total:NULL) !!}">
                                    ...
                                    <div class="form-group col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12 @if($errors->first('show_home')) has-error @endif">
                                            <select name="show_home" id="show_home"   class="form-control" style="width: 100%;" tabindex="-1" aria-hidden="true">
                                                <option @if($dataProducts->show_home == 1 ) selected ="selected" @endif value="1" >Hiển thị</option>
                                                <option @if($dataProducts->show_home == 2 ) selected ="selected" @endif value="2" >Ẩn</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <div class="form-group">
                                               <label>
                                                  <input type="checkbox"  name="hot" class="flat-red" value="1" @if($dataProducts->hot == 1 ) checked @endif>  &nbsp; <span>Chọn</span> 
                                                </label>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12 @if($errors->first('image')) has-error @endif">
                                            <div class="form-group has-feedback">
                                                ...
                                                <div class="preview showimg" id="thumbbox" style="margin-top: 10px;">
                                                    <img id="thumbimage"  src="{{ asset('uploads/admin/products')}}/{{$dataProducts->image}}"  width="30%" alt="Image preview...">
                                    ...
                                    <div class="form-group col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12 ">
                                            <textarea id="description" name="description" rows="10" cols="80">
                                                {!! old('description',isset($dataProducts)?$dataProducts->description:NULL) !!}
                                            </textarea>
                                            <script>
                                    ...
                                    <div class="form-group col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12 ">
                                            <textarea id="content" name="contents" rows="10" cols="80">
                                                {!! old('contents',isset($dataProducts)?$dataProducts->content : NULL) !!}
                                            </textarea>
                                            <script>
                                                ckeditor(content);
                                            </script>
