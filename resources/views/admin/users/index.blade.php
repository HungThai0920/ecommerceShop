                            ...
                            <tbody id="tbody-wallets">
                                ...
                                @foreach($dataUsers as $val)
                                    <tr class="row_{{ $val->id }} select" >
                                        ...
                                        <td>
                                            <a href="{{url('admin/users/getDelete', $val->id)}}"  title="Delete" class="delete-categorys option-delete-modal"  id="{{ $val->id}}" name="{{ $val->name}}"><i  class="fa fa-fw fa-trash-o"></i></a>
                                        </td>
                                    </tr>
                                @endforeach 
                            </tbody>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="col-sm-2" style="margin-top: 20px; padding: 0px;">
                            <button type="button" class="btn btn-warning" id="deleteAll" link = "{{url('admin/users/deleteMultipleUsers')}}" token="{{ csrf_token() }}"> <i class="fa fa-trash"></i> Xóa</button>
                        </div>
                        <div class="col-sm-10">
