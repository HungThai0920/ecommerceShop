...
@section('content')
    ...
    <div class="box">
        <div class="box-header with-border">
            <h2 class="box-title">Thêm Mới Danh Mục Sản Phẩm</h1>
        ...
        <div class="box-body">
            ...
            <form role="form" action="{{url('admin/category/postAdd')}}" method="post" id="form-add">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group col-md-12 col-sm-12 col-xs-12 ">
                        ...
                        <div class=" form-group  col-md-6 col-sm-6 col-xs-12 @if($errors->first('orders')) has-error @endif">
                            <input type="number" min="0"  max="100" name="orders" class="form-control" id="exampleInputWallets" placeholder="" maxlength="255" value="{{ old('orders')}}">
