...
@section('content')
    ...
    <div class="box">
        <div class="box-header with-border">
            <h2 class="box-title">Thêm Mới Nhà Cung Cấp</h1>
        ...
        <div class="box-body">
            ...
            <form role="form" action="{{url('admin/suppliers/postAdd')}}" method="post" id="form-add">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group col-md-12 col-sm-12 col-xs-12 ">
                        ...
                        <div class=" form-group  col-md-6 col-sm-6 col-xs-12 @if($errors->first('email')) has-error @endif">
                            <input type="text" name="email" class="form-control" id="exampleInputWallets" placeholder="" maxlength="255" value="{{ old('email')}}">
                    ...
                    <div class="form-group col-md-12 col-sm-12 col-xs-12 ">
                        ...
                        <div class=" form-group  col-md-6 col-sm-6 col-xs-12 @if($errors->first('address')) has-error @endif">
                            <input type="text" name="address" class="form-control" id="exampleInputWallets" placeholder="" maxlength="255" value="{{ old('address')}}">
                    ...
                    <div class="form-group col-md-12 col-sm-12 col-xs-12 ">
                        ...
                        <div class=" form-group  col-md-6 col-sm-6 col-xs-12 @if($errors->first('phone')) has-error @endif">
                            <input type="text" name="phone" class="form-control" id="exampleInputWallets" placeholder="" maxlength="255" value="{{ old('phone')}}">
