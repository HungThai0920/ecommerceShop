...
@section('content')
    ...
    <div class="box">
        <div class="box-header with-border">
            <h2 class="box-title">Chỉnh Sửa Tin Tức</h2>
        ...
        <div class="box-body">
            ...
            <form role="form" action="{{url('admin/news/postEdit',$dataNews->id )}}" method="post" id="form-add" enctype="multipart/form-data">
                ...
                <div class="box-body">
                    <div class="form-group col-md-12 col-sm-12 col-xs-12 ">
                        ...
                        <div class=" form-group  col-md-6 col-sm-6 col-xs-12 @if($errors->first('title')) has-error @endif">
                            <input type="text" name="title" class="form-control"  placeholder="" maxlength="255" value="{!! old('name',isset($dataNews)?$dataNews->title:NULL) !!}">
                   ...
                   <div class="form-group col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12 @if($errors->first('cate_new_id')) has-error @endif">
                            <select name="cate_new_id" id="cate_new_id"  class="form-control" style="width: 100%;" tabindex="-1" aria-hidden="true">
                                ...
                                @foreach($dataCategoryNew as $val)
                                    <option @if($dataNews->cate_new_id == $val['id'] ) selected ="selected" @endif value="{{ $val['id']}}">{{ $val['name']}}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="form-group col-md-12 col-sm-12 col-xs-12 ">
                        ...
                        <div class=" form-group  col-md-6 col-sm-6 col-xs-12 @if($errors->first('info')) has-error @endif">
                            <input type="text" name="info" class="form-control" id="exampleInputWallets" placeholder=""  value="{!! old('info',isset($dataNews)?$dataNews->info:NULL) !!}">
                    ...
                    <div class="form-group col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12 @if($errors->first('status')) has-error @endif">
                            <select name="status" id="status"   class="form-control" style="width: 100%;" tabindex="-1" aria-hidden="true">
                                <option @if($dataNews->status == 1 ) selected ="selected" @endif value="1" >Hiển thị</option>
                                <option @if($dataNews->status ==2)  selected ="selected" @endif value="2" >Ẩn</option>
                            </select>
                    ...
                    <div class="form-group col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12 @if($errors->first('status')) has-error @endif">
                            <textarea id="content" name="content" rows="10" cols="80">
                                {!! old('name',isset($dataNews)?$dataNews->content:NULL) !!}
                            </textarea>
                            <script>
                                ckeditor(content);
                            </script>
                            ...
                            <div class="form-group has-feedback">
                                ...
                                <input type="file" id="uploadfile" name="imgs"  value="" placeholder = "" onChange="readURL(this);" >
                                    <div class="preview showimg" id="thumbbox" style="margin-top: 10px;">
                                      <img id="thumbimage"  src="{{ asset('uploads/admin/news')}}/{{$dataNews->image}}"  width="30%" alt="Image preview...">
