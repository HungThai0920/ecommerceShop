...
<div class="box">
    ...
    <div class="box-body">
        ...
        <form role="form" action="{{url('admin/abouts/postEdit',$dataAbouts->id )}}" method="post" id="form-add" enctype="multipart/form-data">
                ...
                <div class="form-group col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12 @if($errors->first('status')) has-error @endif">
                        <select name="status" id="status"   class="form-control" style="width: 100%;" tabindex="-1" aria-hidden="true">
                            <option @if($dataAbouts->status == 1 ) selected ="selected" @endif value="1" >Hiển thị</option>
                            <option @if($dataAbouts->status ==2)  selected ="selected" @endif value="2" >Ẩn</option>
                        </select>
                ...
                <div class="form-group col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12 @if($errors->first('status')) has-error @endif">
                            <textarea id="content" name="content" rows="10" cols="80">
                                {!! old('name',isset($dataAbouts)?$dataAbouts->content:NULL) !!}
                            </textarea>
                        <script>
                            ckeditor(content);
                        </script>
