...
@section('content')
    ...
    <div class="box">
        <div class="box-header with-border">
            <h3 class="box-title">Danh Sách Danh Mục Tin Tức</h3>
            ...
            <div id="example1_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
                            ...
                            <tbody id="tbody-wallets">
                                ...
                                @foreach($dataCateNews as $val)
                                    <tr class="row_{{ $val->id }} select" >
                                        ...
                                        <td>
                                            <a href="{{url('admin/category-new/getEdit', $val->id)}}"  title="Edit" class=""><i class="fa fa-fw fa-edit"></i></a>
                                            <a href="{{url('admin/category-new/getDelete', $val->id)}}"  title="Delete" class="delete-categorys option-delete-modal"  id="{{ $val->id}}" name="{{ $val->name}}"><i  class="fa fa-fw fa-trash-o"></i></a>
                                        </td>
                                    </tr>
                                @endforeach 
                            </tbody>
                ...
                <div class="row">
                    <div class="col-sm-2" style="margin-top: 20px;">
                        <button type="button" class="btn btn-warning" id="deleteAll" link="{{url('admin/category-new/deleteMultipleCategoryNews')}}" token="{{ csrf_token() }}"> <i class="fa fa-trash"></i> Xóa</button>
                    </div>
                    <div class="col-sm-10">
